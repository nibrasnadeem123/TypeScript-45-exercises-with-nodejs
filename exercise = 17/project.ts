...
console.log(`sorry ${removeguest} i cna't invite you to dinner with me`)
}
// sending message to the last two guest
console.log("invitation to the last two guest")

// sending message to the last two guest
guestlist.forEach(oneguest => console.log(`luckly, ${oneguest} you will still invited to dinner with me.`))
